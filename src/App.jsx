...
function App() {
  useEffect(() => {
    ...
    const cubeTexture = new THREE.TextureLoader().load( 'https://github.com/GanyuHail/3dUni/blob/af0410ab94f43f47c605838cd9db4d380639afb7/src/assets/uni.jpg?raw=true' );
