...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function wh(){return new nr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gf(),fragmentShader:`
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function Eh(){return new nr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gf(),fragmentShader:`
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function gf(){return`
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sw=ro.exports,ow=Symbol.for("react.element"),aw=Symbol.for("react.fragment"),lw=Object.prototype.hasOwnProperty,uw=sw.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,cw={key:!0,ref:!0,__self:!0,__source:!0};function Ag(n,e,t){var i,r={},s=null,o=null;t!==void 0&&(s=""+t),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)lw.call(e,i)&&!cw.hasOwnProperty(i)&&(r[i]=e[i]);if(n&&n.defaultProps)for(i in e=n.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:ow,type:n,key:s,ref:o,props:r,_owner:uw.current}}sl.Fragment=aw;sl.jsx=Ag;sl.jsxs=Ag;(function(n){n.exports=sl})(bg);const Ua=bg.exports.jsx;function fw(){return ro.exports.useEffect(()=>{const n=new $M,e=new Gt(50,window.innerWidth/window.innerHeight,1,1e3);e.position.z=96;const t=document.getElementById("myThreeJsCanvas"),i=new Eg({canvas:t,antialias:!0});i.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(i.domElement);const r=new iw(16761035,.5);r.castShadow=!0,n.add(r);const s=new nw(16777215,1);s.castShadow=!0,s.position.set(0,64,32),n.add(s);const o=new vf(12,64,32),a=new JM().load("https://raw.githubusercontent.com/GanyuHail/3dUni/af0410ab94f43f47c605838cd9db4d380639afb7/src/assets/uni.jpg");texture.wrapS=Oa,texture.repeat.set(1,1);const l=new hf({map:a}),u=new Wn(o,l);n.add(u);const c=new rw(e,i.domElement),f=()=>{u.rotation.x+=.001,u.rotation.y+=.001,c.update(),i.render(n,e),window.requestAnimationFrame(f)};f()},[]),Ua("div",{children:Ua("canvas",{id:"myThreeJsCanvas"})})}mu.createRoot(document.getElementById("root")).render(Ua(Kg.StrictMode,{children:Ua(fw,{})}));
